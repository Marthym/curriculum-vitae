...
{\vspace{0.2cm}\emph{Expert développement Java} \discretright{/ Java 8, Wisdom, OSGI, Ansible, Docker /}\\
...
J'ai de plus pris part à la réalisation de la nouvelle génération du produit "b.lo". Basé sur une architecture orienté micro-services REST, à base de Java 8 et d'OGSI (Wisdom), ce projet m'a permis de consolider mes compétences de développeur ainsi que mes aptitudes à travailler en équipe.
}\\
